...
class Error<T> implements SignupState<T> {
  const Error({required this.errorModel});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Error<T>&&(identical(other.errorModel, errorModel) || other.errorModel == errorModel));
}
