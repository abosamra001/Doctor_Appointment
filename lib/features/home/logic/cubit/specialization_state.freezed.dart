...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecializationState<T>);
}
...
/// @nodoc
class $SpecializationStateCopyWith<T,$Res>  {
$SpecializationStateCopyWith(SpecializationState<T> _, $Res Function(SpecializationState<T>) __);
}


/// Adds pattern-matching-related methods to [SpecializationState].
extension SpecializationStatePatterns<T> on SpecializationState<T> {
...
class _Initial<T> implements SpecializationState<T> {
  const _Initial();
...
class Loading<T> implements SpecializationState<T> {
  const Loading();
...
class Success<T> implements SpecializationState<T> {
...
@override
String toString() {
  return 'SpecializationState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SpecializationStateCopyWith<T, $Res> {
...
class Error<T> implements SpecializationState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $SpecializationStateCopyWith<T, $Res> {
